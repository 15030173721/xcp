...
$cfg_basehost = 'http://xcp.huashifengxing.com/';
$cfg_cmspath = '';
$cfg_cookie_encode = 'L1oer7V33NBDFEgmLPHdCRUryMo8';
$cfg_indexurl = 'http://xcp.huashifengxing.com/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '【华视风行】宣传片制作|婚礼摄像|摄影器材租赁|大型会议拍摄|录课室出租|课程录制';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = '北京华视风行文化传媒有限公司 | © 2014-2018 版权所有 京ICP备15024202号-2';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '上海宣传片制作,视频制作,婚礼摄像,年会拍摄,大型会议拍摄，后期制作，专业视频制作公司，上海婚礼摄像，会议摄像';
$cfg_description = '华视风行，致力于传媒和教育双线并行，主要业务是企业宣传片制作,录课室出租,在线课程录制,影视器材租赁,视频拍摄剪辑制作等影视服务。作为一家专业的影视文化传媒服务公司，华视风行传媒中心将引领中国民营影视团体发展。';
$cfg_beian = '京ICP备15024202号-2';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
